(this.nativeLog || function(s) {console.log(s)})('Start JS Framework 0.26.19, Build at 2018-07-03 16:49. (Vue: 2.5.13-weex.5, Rax: 0.4.20)');
...
var subversion = {"framework":"0.26.19","transformer":">=0.1.5 <0.5"};
...
function getJSFMVersion () {
  ...
  return "0.26.19" // eslint-disable-line
}
...
/**
  * windmill.weex-vue-plugin.js v0.1.8.
  */
console.log('Start windmill weex-vue-plugin (0.1.8) framework. Build at 2018-07-03 15:53');
(function (global, factory) {
...
function debounce(fn, delay) {
    ...
    return function debounceWrapper() {
        ...
        timerId = setTimeout(function () { return fn.apply(context, args); }, delay);
    };
}
...
var availableModules = {
    ...
    navigatorBar: [
        ...
        'openDrawer', 'isDrawerOpened', 'closeDrawer', 'setLeftItem', 'showMenu', 'hideMenu'
    ],
    ...
    wopc: ['authLogin', 'checkAuthSession', 'doAuth'],
...
// $navTo: nav to url.
AppRuntime.prototype.$navTo = function $navTo (params) {
    debug(("$navTo(" + (JSON.stringify(params)) + ")"));
    return this.$callAsync('navigator.open', params);
};
...
function createModuleGetter(getRuntime, moduleInterceptor // intercept a module call
    ...
    return function requireModule(moduleName) {
        ...
        moduleProxies[moduleName] = apis;
        return apis;
    };
}

var scopedModuleRE = /^@(windmill|weex)\/([\w_-]+)/;
function scopedModuleAdaptor(weex, windmill) {
    ...
    var requireWindmillModule = createModuleGetter(function () { return windmill; });
    ...
    weex.requireModule = function requireScopedModule(name) {
        ...
        switch (scope) {
            case 'weex': return requireWeexModule.call(weex, moduleName);
            case 'windmill': return requireWindmillModule(moduleName);
            default: {
                console.error("[JS Framework] Failed to require scoped module "
                    + "(\"" + moduleName + "\"), the scope (\"" + scope + "\") is unknown.");
            }
        }
    };
    return weex;
...
function get$page(windmill, pageInstance, options) {
    var handlersMap = {};
    var normalize = options && options.normalizeEventName || (function (name) { return name; });
    var noTriggerWorker = !!(options && options.noTriggerWorker);
    function attachDestroy(id) {
        var vm = pageInstance.getVm();
        if (!vm._clearWindmillPageBinding) {
            vm._clearWindmillPageBinding = function () {
                var innerMap = handlersMap[id];
                Object.keys(innerMap).forEach(function (name) {
                    var datas = innerMap[name];
                    datas.forEach(function (data) {
                        offHandler(name, data.handler);
                    });
                });
            };
        }
    ...
    function addHandler(name, handler, wrap, once) {
        ...
        innerMap[name].push({ handler: handler, wrap: wrap });
        if (once) {
    ...
    var noop = function () { };
    var getDefaultStrat = function (hookName) { return function () {
        var arguments$1 = arguments;
...
function setup(api) {
    ...
    newAPI.createInstanceContext = function (instanceId, runtimeContext, data) {
        ...
        context.requireModule = function (name) { return weex.requireModule(name); };
...
frameworks$1.Vue = dist(frameworks$1.Vue);
setup(frameworks$1);
freezePrototype();
