console.log("Prepare Rax APIs 0.4.12, Build at 2018-07-20 11:15.");
...
/* 0 */
/*!***************************************************************************************!*\
  !*** ./packages/weex-rax-framework-api/node_modules/event-target-shim/lib/commons.js ***!
  \***************************************************************************************/
...
/* 1 */
/*!********************************************************************************************!*\
  !*** ./packages/weex-rax-framework-api/node_modules/event-target-shim/lib/event-target.js ***!
  \********************************************************************************************/
/*! no static exports found */
/*! all exports used */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */
...
var CustomEventTarget = __webpack_require__(/*! ./custom-event-target */ 9);
var EventWrapper = __webpack_require__(/*! ./event-wrapper */ 8);
...
var eventTarget = __webpack_require__(/*! event-target-shim */ 1);
...
module.exports = function (__weex_require__, isInWindmill) {
  ...
  var WebSocket = function (_eventTarget) {
    ...
    function WebSocket(url, protocols) {
      ...
      var newWebSocket = websocket.WebSocket;
      var onopen = websocket.onopen;
      var onclose = websocket.onclose;
      var onmessage = websocket.onmessage;
      var onerror = websocket.onerror;
...
/* 8 */
/*!*********************************************************************************************!*\
  !*** ./packages/weex-rax-framework-api/node_modules/event-target-shim/lib/event-wrapper.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/*! all exports used */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */
...
/* 9 */
/*!***************************************************************************************************!*\
  !*** ./packages/weex-rax-framework-api/node_modules/event-target-shim/lib/custom-event-target.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/*! all exports used */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */
...
var _emitter = __webpack_require__(/*! ./emitter */ 2);
...
var _semver = __webpack_require__(/*! ./semver */ 14);
...
function check(config) {
  ...
  for (var i in deviceInfo) {
    ...
    var isOsVersion = keyLower.indexOf('osversion') >= 0;
...
module.exports = function (modules, weex, windmill) {
  var isInWindmill = weex.config.container === 'windmill';
      ...
      var _ret = function () {
        ...
        if (isInWindmill && isAvailableWindmillModule(weexModuleName)) {
          ...
          var _loop = function _loop(i) {
            var api = availableWindmillModules[weexModuleName][i];
            // network 兼容
            modObj[api] = function (parames, successCallback, failureCallback) {
              // console.log('$call: ' + weexModuleName + '.' + api);
              windmill.$call(weexModuleName + '.' + api, parames, successCallback, failureCallback);
            };
          };

          for (var i = 0; i < availableWindmillModules[weexModuleName].length; i++) {
            _loop(i);
          }
          if (weexModuleName == 'network') {
            modObj.fetch = function (parames, successCallback, failureCallback) {
          ...
          if (weex.isRegisteredModule(weexModuleName)) {
            return {
              v: weex.requireModule(weexModuleName)
            };
          } else {
...
var _flattenChildren = __webpack_require__(16);
...
var _styleUnit = __webpack_require__(10);

var _flexbox = __webpack_require__(25);
...
var _composite = __webpack_require__(41);
...
var _driverWeex = __webpack_require__(36);
...
var _purecomponent = __webpack_require__(45);
...
var _hydrate2 = __webpack_require__(24);

var _hydrate3 = _interopRequireDefault(_hydrate2);

var _createPortal2 = __webpack_require__(23);
...
var _createContext2 = __webpack_require__(18);
...
var ModuleFactories = exports.ModuleFactories = {
  'rax': __webpack_require__(/*! rax/dist/rax.factory */ 19)
};

/***/ }),
/* 21 */
/*!************************************************************************************!*\
  !*** ./node_modules/_@ali_windmill-renderer@0.3.2@@ali/windmill-renderer/index.js ***!
  \************************************************************************************/
/*! no static exports found */
/*! all exports used */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */
...
/**
  * windmill.renderer.js v0.3.2.
  */
console.log('Start windmill renderer (0.3.2) framework. Build at 2018-07-20 10:21');
(function (global, factory) {
     module.exports = factory();
}(this, (function () { if (typeof Object.assign != 'function') {
...
var availableModules = {
    miniApp: ['setAppShareInfo', 'hideLauncherLoading'],
    network: ['request'],
    mtop: ['request'],
    storage: ['length', 'setItem', 'getItem', 'removeItem'],
    memoryStorage: ['setItem', 'getItem'],
    navigator: ['push', 'pop', 'openMessagePage', 'reloadPage', 'getBackStack', 'popToHome'],
    user: ['login', 'logout', 'info'],
    modal: ['alert', 'confirm', 'toast'],
    navigatorBar: [
        'show', 'hide', 'setTitle', 'setRightItem', 'setStyle', 'setDrawer', 'setActionSheet',
        'hasIndexBadge', 'scaleIndexBadge', 'resetIndexBadge', 'getHeight',
        'openDrawer', 'isDrawerOpened', 'closeDrawer', 'setLeftItem', 'showMenu', 'hideMenu', 'getStatusBarHeight'
    ],
    clipboard: ['writeText', 'readText'],
    picker: ['pick', 'pickDate', 'pickTime', 'chooseCity'],
    webSocket: ['webSocket', 'send', 'close', 'onOpen', 'onMessage', 'onClose', 'onError'],
    calendar: ['addEvent', 'checkEvent', 'removeEvent'],
    connection: ['getType', 'getDownlinkMax', 'onChange'],
    screen: ['setAlwaysOn', 'setBrightness'],
    broadcast: ['createChannel', 'postMessage', 'onMessage', 'close'],
    share: ['doShare'],
    cookie: ['read', 'write', 'getAllObjects'],
    audio: ['load', 'play', 'pause', 'stop', 'setVolume', 'canPlayType'],
    wopc: ['authLogin', 'checkAuthSession', 'doAuth', 'getSessionKey', 'setSessionKey'],
    WopcMtopPlugin: ['request'],
    device: ['onShake', 'vibrate'],
    keyboard: ['hideKeyboard'],
    contact: ['choosePhoneContact'],
    location: ['getLocation'],
    alipay: ['tradePay'],
    userTrack: [
        'commit', 'commitut', 'commitEvent', 'customAdvance', 'pageAppear',
...
function registerModules(modules, noWarning) {
    if ( noWarning === void 0 ) { noWarning = false; }
    ...
    var loop = function ( moduleName ) {
        ...
        var moduleDefine = availableModules[moduleName];
...
AppRuntime.prototype.$call = function $call (method, params, successCallback, failureCallback) {
        ...
        if ( failureCallback === void 0 ) { failureCallback = noop; }
...
AppRuntime.prototype.$getAvailableModules = function $getAvailableModules () {
    return deepClone(availableModules);
};
...
LazyMessageModule.prototype._flush = function _flush () {
    ...
    this._messages.forEach(function (msg) { return this$1._messageModule.postMessage(msg); });
};
 ...
 * real messageModule is ready, we'll set the onMesssage hook to it.
...
function getMessageModule(weex, onMessage) {
    ...
    // set onmessage method to msg module.
    if ('set onmessage through callback.' && typeof onMessage === 'function') {
...
var RendererBridge = function RendererBridge(weex, option) {
    ...
    this._onMessage = function (message) {
        ...
        var msgData = message.data; if ( msgData === void 0 ) { msgData = {}; }
            ...
            case "Event" /* Event */:
                {
                    ...
                    this$1._emitter.emit((type + "." + eventType), Object.assign({ origin: origin }, msgData, { type: eventType }));
                }
                break;
...
RendererBridge.prototype.onReceiveMessage = function onReceiveMessage (message, callback) {
    var type = message.type;
        var data = message.data; if ( data === void 0 ) { data = {}; } // Event / Lifecycle
    var name = data.type;
    if (type === "Event" /* Event */) {
...
RendererBridge.prototype.emitEvent = function emitEvent (event, data) {
    ...
    this._emitter.emit((("Event") + "." + evtName), { type: evtName, data: data });
};
...
var RendererRuntime = (function (AppRuntime$$1) {
    ...
    if ( AppRuntime$$1 ) { RendererRuntime.__proto__ = AppRuntime$$1; }
    ...
    RendererRuntime.prototype._ready = function _ready () {
        var this$1 = this;
...
function index (weex, options) {
    ...
    var app = new RendererRuntime(weex, options);
    debug(("Prepare runtime APIs: " + (JSON.stringify(exposedAPIs))));
    return pickMethods(app, exposedAPIs);
}
...
var _windmillRenderer = __webpack_require__(/*! @ali/windmill-renderer */ 21);

var _windmillRenderer2 = _interopRequireDefault(_windmillRenderer);

var _builtin = __webpack_require__(/*! ./builtin */ 20);
...
var BROADCAST_EVENT_MODULE = MODULE_NAME_PREFIX + 'broadcast';
...
function initPageEvent(windmill, window) {
  var supportedPageLifecycles = ['load', 'ready', 'show', 'hide', 'unload'];
  var supportedPageEvents = ['pullDownRefresh', 'reachBottom', 'shareAppMessage', 'pageScroll', 'tabItemTap'];

  // listening on page lifecycles
  supportedPageLifecycles.forEach(function (lifecycle) {
    var eventType = 'page:' + lifecycle;
    console.log('[Rax] listening on lifecycle: "' + eventType + '"');
    windmill.$cycle(eventType, function (options) {
  ...
  supportedPageEvents.forEach(function (eventType) {
    console.log('[Rax] listening on event: "' + eventType + '"');
    windmill.$on(eventType, function (event) {
  ...
  var errorName = 'weexsecurityerror';
  windmill.$on(errorName, function (message) {
    var errorEvent = typeof window.CustomEvent === 'function' ? new window.CustomEvent('WeexSecurityError', { detail: message }) : { type: 'WeexSecurityError', detail: message };
...
function resetInstanceContext(instanceContext) {
  ...
  var windmill = void 0;
  if (isInWindmill) {
    windmill = (0, _windmillRenderer2.default)(weex);
  }
  ...
  var shared = __webpack_require__(/*! runtime-shared/dist/shared.function */ 18)();
  ...
  var __weex_define__ = __webpack_require__(/*! ./define.weex */ 17)(modules);
  var __weex_require__ = __webpack_require__(/*! ./require.weex */ 16)(modules, weex, windmill);
  var __weex_downgrade__ = __webpack_require__(/*! ./downgrade.weex */ 15)(__weex_require__);
  // Extend document
  __webpack_require__(/*! ./document.weex */ 13)(__weex_require__, document);

  var location = __webpack_require__(/*! ./location.weex */ 12)(__weex_require__, documentURL);

  var _require = __webpack_require__(/*! ./fetch.weex */ 11)(__weex_require__, Promise),
      fetch = _require.fetch,
      Headers = _require.Headers,
      Request = _require.Request,
      Response = _require.Response;

  var XMLHttpRequest = __webpack_require__(/*! ./xmlhttprequest.weex */ 10)(__weex_require__);
  var WebSocket = __webpack_require__(/*! ./websocket.weex */ 7)(__weex_require__, isInWindmill);

  var _require2 = __webpack_require__(/*! ./timer.weex */ 6)(__weex_require__, document),
  ...
  var _require3 = __webpack_require__(/*! ./base64.weex */ 5)(),
      atob = _require3.atob,
      btoa = _require3.btoa;

  var performance = __webpack_require__(/*! ./performance.weex */ 4)(responseEnd);

  var _require4 = __webpack_require__(/*! ./event.weex */ 3)(),
  ...
  var window = {
    ...
    postMessage: function postMessage(message, targetOrigin) {
      ...
      if (isInWindmill) {
        ...
        var name = 'message' + targetOrigin;
        if (targetOrigin == '*') {
          name = 'message';
        }
        var broadcast = __weex_require__(BROADCAST_EVENT_MODULE);
    ...
    // Weex
    callNative: function callNative() {}, // compatible original API
  ...
  if (isInWindmill) {
    console.log('Rax miniApp jsfm init window, typeof window is ', typeof window === 'undefined' ? 'undefined' : _typeof(window));
  } else {
    console.log('Rax jsfm init window, typeof window is ', typeof window === 'undefined' ? 'undefined' : _typeof(window));
  }
  return window;
}
