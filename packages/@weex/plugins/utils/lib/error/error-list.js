...
(function (ERROR_LIST) {
    ...
    ERROR_LIST["IOS_COCOAPODS_NOT_INITIALIZED"] = "IOS_COCOAPODS_NOT_INITIALIZED";
    ERROR_LIST["IOS_COCOAPODS_NOT_INSTALLED"] = "IOS_COCOAPODS_NOT_INSTALLED";
...
exports.IOS_COCOAPODS_NOT_INITIALIZED = error_1.createError({
    type: ERROR_LIST.IOS_COCOAPODS_NOT_INITIALIZED,
    message: `CocoaPods installed but not initialized!`,
});
exports.IOS_COCOAPODS_NOT_INSTALLED = error_1.createError({
